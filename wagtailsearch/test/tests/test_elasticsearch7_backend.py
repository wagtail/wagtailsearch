...
from wagtailsearch.query import MATCH_ALL, Fuzzy, Phrase
...
try:
    ...
    from wagtailsearch.backends.elasticsearch7 import Elasticsearch7SearchBackend
except ImportError:
...
class TestElasticsearch7SearchBackend(ElasticsearchCommonSearchBackendTests, TestCase):
    backend_path = "wagtailsearch.backends.elasticsearch7"
...
@unittest.skipIf(ELASTICSEARCH_VERSION[0] != 7, "Elasticsearch 7 required")
@mock.patch("wagtailsearch.backends.elasticsearch7.SearchBackend.connection_class")
